...
const quickLinks = [
  {
    href: "/admin",
    title: "CMS",
    description: "Manage pages, news, media, ticket catalog and merch catalog in Payload.",
    color: "violet",
  },
  {
    href: "/admin/tickets",
  ...
  },
  {
    href: "/admin/products",
    title: "Products",
    description: "Manage merch — t-shirts and other items sold in the shop.",
    color: "sky",
  },
  {
    href: "/admin/product-orders",
    title: "Product Orders",
    description: "Paid merch purchases and their festival pickup status.",
    color: "fuchsia",
  },
  {
